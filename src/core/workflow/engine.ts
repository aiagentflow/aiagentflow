...
export const WorkflowState = {
    ...
    SecurityChecked: 'security_checked',
...
export type WorkflowEvent =
    ...
    | { type: 'SECURITY_CHECKED'; payload: { passed: boolean; findings: string } }
...
const VALID_TRANSITIONS: Record<WorkflowStateValue, WorkflowStateValue[]> = {
    ...
    review_done: ['security_checked', 'tests_written', 'failed'],
    review_rejected: ['fix_applied', 'failed'],
    security_checked: ['tests_written', 'review_rejected', 'failed'],
    tests_written: ['tests_passed', 'tests_failed', 'failed'],
    tests_passed: ['qa_approved', 'failed'],
    tests_failed: ['fix_applied', 'failed'],
    fix_applied: ['code_generated', 'failed'],
...
export const STATE_AGENT_MAP: Partial<Record<WorkflowStateValue, AgentRole>> = {
    ...
    review_done: 'security',
    security_checked: 'tester',
...
export function transition(
    ...
    switch (event.type) {
        ...
        case 'SECURITY_CHECKED':
            updated.securityFindings = event.payload.findings;
            break;
        case 'TESTS_WRITTEN':
...
function resolveNextState(current: WorkflowStateValue, event: WorkflowEvent): WorkflowStateValue {
    switch (event.type) {
        ...
        case 'SECURITY_CHECKED':
            return event.payload.passed ? WorkflowState.SecurityChecked : WorkflowState.ReviewRejected;
